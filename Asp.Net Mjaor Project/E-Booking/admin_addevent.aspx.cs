...
public partial class admin_admin_event : System.Web.UI.Page
{
        ...
        if (imgload.HasFile)
        {
           ...
           Stream fs = imgload.PostedFile.InputStream;
            ...
            if (imgload.PostedFile.ContentLength < 240800)
            {
                ...
                string cmdtext = @"insert into admin_addevent (image,addevent_id,title,description,date,time,category,address,price)
