<%@ Page Title="" Language="C#" MasterPageFile="~/U n G MasterPage.master" AutoEventWireup="true" CodeFile="Booksports.aspx.cs" Inherits="MyDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <ItemTemplate>
        <table>
            <tr>
                <td> <asp:Label ID="lblid" runat="server" src='<%#Eval("sports_id")%>'></asp:Label>  </td>
            </tr>
            <tr>
